...
def new_post():
    ...
    return render_template('edit_post.html', title='New Post', name='New Post', form=form)
...
def update_post(post_id):
    ...
    return render_template('edit_post.html', title=post.title, name='Update Post', form=form)
